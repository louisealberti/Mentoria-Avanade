...
public class MainController {
	...
	public String criaEstoque(@PathVariable Integer codigoFilial, @PathVariable Integer codigoProduto,
	...
	public String atualizaEstoque(@PathVariable Integer codigoFilial, @PathVariable Integer codigoProduto,
			@PathVariable Integer quantidade) {
